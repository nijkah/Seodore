...
from geojson2coco_20 import geojson2coco
import argparse
...
def parse_args():
    ...
    parser.add_argument('--dstpath', default=r'../data/nia_20-split',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    split_train = imgsplit_multiprocess.splitbase(os.path.join(srcpath),
