...
int ROIAlignRotatedForwardCPULauncher(const at::Tensor features, const at::Tensor rois,
...
int ROIAlignRotatedBackwardCPULauncher(const at::Tensor top_grad, const at::Tensor rois,
    const float spatial_scale, const int sample_num,
    const int channels, const int height,
    const int width, const int num_rois,
    const int pooled_height, const int pooled_width,
