...
if __name__ == '__main__':
    ...
    config_file = r'configs/nia2020/faster_rcnn_RoITrans_r101_fpn_2x_nia_768.py'
    checkpoint_file = r'work_dirs/faster_rcnn_RoITrans_r101_fpn_2x_nia_768/epoch_12.pth'
    roitransformer = DetectorModel(config_file, checkpoint_file)

    #from glob import glob
    #targets = glob('data/nia/test/images/*.png')
    import torch
