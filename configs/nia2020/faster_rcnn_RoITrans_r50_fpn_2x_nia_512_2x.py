...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'train512_2x/coco.json',
            img_prefix=data_root + 'train512_2x/images',
            img_scale=(1024, 1024),
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test512_2x/coco.json',
        img_prefix=data_root + 'test512_2x/images',
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_RoITrans_r50_fpn_2x_nia_512_2x'
load_from = None
resume_from = None
workflow = [('train', 1)]
